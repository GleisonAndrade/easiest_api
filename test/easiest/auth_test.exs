defmodule EasiestApp.AuthTest do
  use EasiestApp.DataCase

  alias EasiestApp.Auth

  describe "users" do
    alias EasiestApp.Auth.User

    @valid_attrs %{email: "some email", is_active: true, name: "some name", password: "some password"}
    @update_attrs %{email: "some updated email", is_active: false, name: "some updated name", password: "some updated password"}
